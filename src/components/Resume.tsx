...
import ResumePDF from '../Assets/Nayani_Resume.pdf';
...
export function Resume() {
  ...
  const education = [
    {
      ...
      period: '2023 - Present',
      description:
        'Currently pursuing a degree in ICT with a focus on UI/UX design, software development, and digital innovation',
    },
    {
      ...
      period: '2019 - 2021',
      description:
        'Completed secondary education with a strong foundation in technology and design',
    },
  ];
  ...
  return (
    <section
      id="resume"
      ref={ref}
      className="relative py-32 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-yellow-500/5 to-black"
    >
